 ...
 */
static char *lookup_variable(struct conn_s *connptr, char *varname)
{
  int i;
 ...
 */
int add_error_variable(struct conn_s *connptr, char *key, char *val)
{
 ...
 */
int indicate_http_error(struct conn_s *connptr, int number, char *message, ...)
{
  va_list ap;
  char *key, *val;
